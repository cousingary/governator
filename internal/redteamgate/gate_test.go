...
// fixture) parses cleanly under the Sol12 strict decoder: 272
...
func TestLoadManifestAcceptsRealManifest(t *testing.T) {
	...
	if len(m.Cases) != 272 {
		t.Fatalf("expected 272 cases in the mandatory final attack corpus, got %d", len(m.Cases))
	}
