...
func v14S6Evidence(t *testing.T, commit string) string {
	t.Helper()
	dir := t.TempDir()
	write := `{"governor_binary_sha256":"gov","governor_binary_source":"env","enforce_supported":true,"sandbox_mechanism":"landlock+unshare (enforce.Supported)","self_exe_route":"fd-override","assayer_source":"ASSAYER_REPO","assayer_commit":"` + commit + `","assayer_version":"1.1.11","assayer_tag":"v1.1.11","assayer_package_tree_hash":"tree","assayer_schema_version":"0004","assayer_python_runtime":"Python 3.12","assayer_clean":true}`
...
func TestV14Case330AssayerCheckoutCommitMustEqualReleaseCommit(t *testing.T) {
	commit := "258770ddabb098f43a4b550a00d55b1cd77a658f"
